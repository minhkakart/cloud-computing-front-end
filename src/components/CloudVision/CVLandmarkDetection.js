    ...
    const handleProcess = async (gcs_uri) => {
        ...
        const response = await axios.post(
            process.env.REACT_APP_API_DOMAIN +
                "/api/cloud-vision/landmark-detection",
            {
                gcs_uri,
            },
            {
        ...
        <div>
            ...
            <div className="d-flex flex-column mt-4">
                <Card>
                    ...
                    <Card.Body>
                        <Card.Text>
                            {descriptions.length === 0 && <p>No result</p>}
                            {descriptions.join(", ")}
                        </Card.Text>
                    </Card.Body>
                </Card>
...
export default CVLandmarkDetection;
