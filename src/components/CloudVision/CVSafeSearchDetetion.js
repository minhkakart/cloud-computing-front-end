...
function CVSafeSearchDetetion() {
    ...
    const [safeSearch, setSafeSearch] = useState(null);
    ...
    const handleProcess = async (gcs_uri) => {
        ...
        const response = await axios.post(
            process.env.REACT_APP_API_DOMAIN +
                "/api/cloud-vision/safe-search-detection",
            {
                gcs_uri,
            },
            {
        ...
        <div>
            ...
            <div className="d-flex flex-column mt-4">
                <Card>
                    ...
                    <Card.Body>
                        <Card.Text>
                            {safeSearch === null ? (<p>No result</p>) : (
                                <div className="mb-3">
                                    <p className="fs-3 mb-2">Safe Search Detection</p>
                                    <p className="m-0">Spoof: {safeSearch.spoofLikelihood}</p>
                                    <p className="m-0">Medical: {safeSearch.medicalLikelihood}</p>
                                    <p className="m-0">Violence: {safeSearch.violenceLikelihood}</p>
                                    <p className="m-0">Racy: {safeSearch.racyLikelihood}</p>
                                </div>
                            )}
                        </Card.Text>
                    </Card.Body>
...
export default CVSafeSearchDetetion;
